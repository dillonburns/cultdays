...
Sparkle.prototype = {
  ...
  "draw" : function( time, fade ) {
    ...
    for( var i = 0; i < this.options.count; i++ ) {
      ...
      ctx.drawImage(this.sprite, derpicle.style, 0, derpsize,derpsize, derpicle.position.x, derpicle.position.y, 7, 7);
      ...
      if( this.options.color ) {
        ...
        ctx.fillRect(derpicle.position.x, derpicle.position.y, derpsize,derpsize);
